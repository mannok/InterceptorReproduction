...
namespace InterceptorReproduction.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = InterceptorReproductionConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(InterceptorReproductionDbContext context)
        {
            _context = context;
        }
