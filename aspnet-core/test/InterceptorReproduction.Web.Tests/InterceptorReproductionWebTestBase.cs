...
{
    public abstract class InterceptorReproductionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InterceptorReproductionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InterceptorReproductionWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InterceptorReproductionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InterceptorReproductionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InterceptorReproductionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InterceptorReproductionDbContext, Task<T>> func)
        {
            T result;
